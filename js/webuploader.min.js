...
function(a) {
    var b = function(a, b) {
        ...
        f = function(a, e, f) {
            ...
            "function" == typeof e && (f.length || (f = [d, h.exports, h]), g = e.apply(null, f), g !== b && (h.exports = g)),
            c[a] = h.exports
        },
        g = function(b) {
            var d = c[b] || a[b];
    ...
    function(b) {
        ...
        return {
            ...
            inherits: function(a, c, d) {
                ...
                f.prototype = e(a.prototype),
                c && b.extend(!0, f.prototype, c),
                f
            },
            noop: f,
            bindFn: d,
            log: function() {
                return a.console ? d(console.log, console) : f
            } (),
            nextTick: function() {
                return function(a) {
                    setTimeout(a, 1)
    ...
    function(a, b, c) {
        ...
        return b.installTo(d.prototype),
        d
    }),
    ...
    function(a, b) {
        function c(a, c) {
            ...
            !this.type && ~"jpg,jpeg,png,gif,bmp".indexOf(f) && (this.type = "image/" + f),
            this.ext = f,
    ...
    function(b, c, d) {
        function e(a) {
            ...
            a.label = a.label || a.container.text() || "选择文件",
            a.button = f(a.button || document.createElement("div")),
            a.button.text(a.label),
    ...
    function(a, b) {
        ...
        return b.register("FilePicker", {
            init: function(a) {
                ...
                delete b.button,
                delete b.container,
                this.flashExec("FilePicker", "init", b)
            },
            destroy: function() {}
        })
    }),
    ...
    function(a, b, c) {
        return b.register("Transport", {
            ...
            send: function() {
                ...
                e = b._blob,
                f = c.server;
                d.connectRuntime(e.ruid),
                c.sendAsBinary ? (f += (/\?/.test(f) ? "&": "?") + $.param(b._formData), a = e.uid) : ($.each(b._formData,
                function(a, b) {
                    d.exec("append", a, b)
                }), d.exec("appendBlob", c.fileVar, e.uid, c.filename || b._formData.name || "")),
            ...
            _initAjax: function() {
                ...
                function() {
                    ...
                    return b.off(),
                    a._xhr = null,
                    200 === c ? (a._response = b.exec("getResponse"), a._responseJson = b.exec("getResponseAsJson"), a.trigger("load")) : (a._status = c, b.destroy(), b = null, a.trigger("error", "http"))
                }),
                b.on("error",
                function() {
                    b.off(),
    ...
    function(a, b, c) {
        ...
        return b.register("DragAndDrop", {
            ...
            _dragEnterHandler: function(a) {
                return this.elem.addClass("webuploader-dnd-over"),
                a = a.originalEvent || a,
            ...
            _dragLeaveHandler: function() {
                return this.elem.removeClass("webuploader-dnd-over"),
                !1
            },
            _dropHandler: function(b) {
                ...
                for (b = b.originalEvent || b, g = b.dataTransfer, e = g.items, f = g.files, k = !(!e || !e[0].webkitGetAsEntry), i = 0, j = f.length; j > i; i++) h = f[i],
                h.type ? l.push(h) : !h.type && k && m.push(this._traverseDirectoryTree(e[i].webkitGetAsEntry(), l));
                return a.when.apply(a, m).done(function() {
                    n.trigger("drop", d.map(l,
                    function(a) {
                        return new c(o, a)
                    }))
                }),
    ...
    function(a, b, c) {
        return b.register("FilePaste", {
            ...
            _pasteHander: function(a) {
                var b, d, e, f, g, h = [],
                i = this.getRuid();
                for (a = a.originalEvent || a, a.preventDefault(), a.stopPropagation(), b = a.clipboardData.items, f = 0, g = b.length; g > f; f++) d = b[f],
                !d.type || !(e = d.getAsFile()) || e.size < 6 || h.push(new c(i, e));
                h.length && this.trigger("paste", h)
            },
            destroy: function() {
    ...
    c("runtime/html5/image", ["runtime/html5/runtime", "runtime/html5/util", "runtime/html5/imagemeta"],
    function(a, b, c) {
        ...
        return a.register("Image", {
            ...
            init: function() {
                ...
                b.onload = function() {
                    ...
                    !a._metas && ~"image/jpegimage/jpg".indexOf(a.type) ? c.parse(a._blob,
                    function(b, c) {
                        a._metas = c,
            ...
            loadFromBlob: function(a) {
                ...
                c._blob = a,
                c.type = a.type,
                d.src = b.createObjectURL(a.getSource()),
                c.owner.once("load",
                function() {
            ...
            getAsBlob: function(a) {
                ...
                if (a = a || this.type, this.modified || this.type !== a) {
                    if (d = this._canvas, "image/jpeg" === a) {
                        if (e = d.toDataURL("image/jpeg", f.quality / 100), f.preserveHeaders && this._metas && this._metas.imageHead) return e = b.dataURL2ArrayBuffer(e),
                        e = c.updateImageHead(e, this._metas.imageHead),
                        e = b.arrayBufferToBlob(e, a)
            ...
            getAsDataUrl: function(a) {
                ...
                "image/jpeg" === a ? this._canvas.toDataURL(a, b.quality / 100) : this._canvas.toDataURL(a)
            },
    ...
    function(a, b) {
        ...
        c.getExifValue = function(b, d, e, f, g, h) {
            ...
            if (!o) return a.log("Invalid Exif data: Invalid tag type."),
            void 0;
            if (i = o.size * g, j = i > 4 ? d + b.getUint32(e + 8, h) : e + 8, j + i > b.byteLength) return a.log("Invalid Exif data: Invalid data offset."),
            void 0;
        ...
        c.parseExifTags = function(b, c, d, e, f) {
            var g, h, i;
            if (d + 6 > b.byteLength) return a.log("Invalid Exif data: Invalid directory offset."),
            void 0;
            if (g = b.getUint16(d, e), h = d + 2 + 12 * g, h + 4 > b.byteLength) return a.log("Invalid Exif data: Invalid directory size."),
            void 0;
        ...
        c.parseExifData = function(b, d, e, f) {
            ...
            if (1165519206 === b.getUint32(d + 4)) {
                if (i + 8 > b.byteLength) return a.log("Invalid Exif data: Invalid segment size."),
                void 0;
                if (0 !== b.getUint16(d + 8)) return a.log("Invalid Exif data: Missing byte alignment offset."),
                void 0;
                ...
                case 19789:
                    ...
                    break;
                default:
                    return a.log("Invalid Exif data: Invalid byte alignment marker."),
                    void 0
                }
                if (42 !== b.getUint16(i + 2, g)) return a.log("Invalid Exif data: Missing TIFF marker."),
                void 0;
                h = b.getUint32(i + 4, g),
    ...
    function(a, b) {
        ...
        return b.register("Transport", {
            ...
            send: function() {
                ...
                g = c._blob,
                h = e.server;
                e.sendAsBinary ? (h += (/\?/.test(h) ? "&": "?") + d.param(c._formData), b = g.getSource()) : (a = new FormData, d.each(c._formData,
                function(b, c) {
                    a.append(b, c)
                }), a.append(e.fileVar, g.getSource(), e.filename || c._formData.name || "")),
                e.withCredentials && "withCredentials" in f ? (f.open(e.method, h, !0), f.withCredentials = !0) : f.open(e.method, h),
                this._setRequestHeader(f, e.headers),
                b && f.overrideMimeType("application/octet-stream"),
                f.send(b || a)
            },
            getResponse: function() {
                return this._response
    ...
    c("widgets/queue", ["base", "uploader", "queue", "file", "widgets/widget"],
    function(a, b, c, d) {
        var e = a.$,
        f = /\.\w+$/,
        g = d.Status;
        ...
        },
        {
            init: function(a) {
                ...
                if (e.isPlainObject(a.accept) && (a.accept = [a.accept]), a.accept) {
                    for (g = [], d = 0, b = a.accept.length; b > d; d++) f = a.accept[d].extensions,
                    f && g.push(f);
                    g.length && (h = "\\." + g.join(",").replace(/,/g, "$|\\.").replace(/\*/g, ".*") + "$"),
                    this.accept = new RegExp(h, "i")
                }
                this.queue = new c,
            ...
            _addFile: function(a) {
                var b = this;
                if (! (!a || a.size < 6 || b.accept && f.exec(a.name) && !b.accept.test(a.name)) && (a instanceof d || (a = new d(a)), b.owner.trigger("beforeFileQueued", a))) return b.queue.append(a),
            ...
            retry: function(a, b) {
                ...
                void 0;
                for (c = f.queue.getFiles(g.ERROR), d = 0, e = c.length; e > d; d++) a = c[d],
                a.setStatus(g.QUEUED);
        ...
        },
        {
            ...
            _doSend: function(b) {
                ...
                function(a) {
                    ...
                    d = 0;
                    c = b.percentage = a,
                    b.chunks > 1 && (f.each(i.blocks,
                    function(a, b) {
                        d += (b.percentage || 0) * (b.end - b.start)
                    }), c = d / i.size),
                    e.trigger("uploadProgress", i, c || 0)
                }),
                j.on("error",
                function(a) {
                    b.retried = b.retried || 0,
                    b.chunks > 1 && ~"http,abort".indexOf(a) && b.retried < g.chunkRetry ? (b.retried++, j.send()) : (i.setStatus(h.ERROR, a), e.trigger("uploadError", i, a), e.trigger("uploadComplete", i))
                }),
                j.on("load",
                function() {
                    var a, d, f = j.getResponseAsJson() || {};
                    return f._raw = j.getResponse(),
                    d = function(b) {
                        a = b
                    },
                    e.trigger("uploadAccept", b, f, d) || (a = a || "server"),
                    a ? (j.trigger("error", a), void 0) : (1 === i.remaning ? c._finishFile(i, f) : j.destroy(), void 0)
                }),
                k = f.extend(k, {
                    id: i.id,
                    name: i.name,
                ...
                e.trigger("uploadBeforeSend", b, k, l),
                j.appendBlob(g.fileVal, b.blob, i.name),
                j.append(k),
                j.setRequestHeader(l),
                j.send()
            },
    ...
    function(b) {
        ...
        for (c in b) if (d = k, b.hasOwnProperty(c)) {
            for (e = c.split("/"), g = i(e.pop()); f = i(e.shift());) d[f] = d[f] || {},
            d = d[f];
            d[g] = b[c]
        }
        "object" == typeof module && "object" == typeof module.exports ? module.exports = k: a.define && a.define.amd ? a.define(function() {
            return k
        }) : (h = a[j], a[j] = k, a[j].noConflict = function() {
            a[j] = h
        })
    } (b.modules)
} (this);